...
class DataAugmentForObjectDetection():
    ...
    def _addNoise(self, img):
        ...
        b = random.uniform(0.0001, 0.2)
        # return random_noise(img, mode='gaussian', seed=int(time.time()), clip=True,mean=0,var=0.01) * 255
        return random_noise(img, mode='gaussian',clip=True,var = b,mean = 0) * 255
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='E:/peachflowerdata/peachflowerjpg')
    parser.add_argument('--source_xml_path', type=str, default='E:/peachflowerdata/peachflowerxml')
    parser.add_argument('--save_img_path', type=str, default='E:/peachflowerdata/peachflowerjpg2')
    parser.add_argument('--save_xml_path', type=str, default='E:/peachflowerdata/peachflowerxml2')
