...
def get_params():
    params = {
        'weight': './runs/train/exp23/weights/last.pt',  # 训练出来的权重文件
        'cfg': './ultralytics/cfg/models/v8/yolov8-ADown.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'datasets/images/dbt/fzbj/fzbj426.jpg', 'runs/relitu/fzbj4261023')  # 第一个是检测的文件, 第二个是保存的路径